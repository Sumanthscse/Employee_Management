...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            background-color: #bb1135 !important;
            border-color: #bb1135;
        }
        .navbar {
            background-color: #dc143c !important;
...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-5 text-danger">Employee Reports</h1>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-report" data-bs-toggle="modal" data-bs-target="#nameReportModal">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-report" data-bs-toggle="modal" data-bs-target="#serviceReportModal">
                            <i class="fas fa-file-alt me-2"></i>Generate Report
                        </button>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-report" data-bs-toggle="modal" data-bs-target="#salaryReportModal">
                            <i class="fas fa-file-alt me-2"></i>Generate Report
                        </button>
                    </div>
                </div>
        ...
        <div class="text-center mt-4">
            <a href="index.jsp" class="btn btn-outline-crimson">
